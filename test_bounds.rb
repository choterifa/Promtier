...
lines = content.lines
["struct SecondaryEditorCard", "struct EditorCard", "struct ImageSlotView: View {", "struct PlaceholderSlotView: View {", "struct CategoryChip: View {", "struct AIGeneratingOverlay: View {"].each do |target|
